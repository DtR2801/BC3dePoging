...
public sealed partial class MaintenanceDashboardPage : Page
{
    ...
    {
        if (e.ClickedItem is Appointment clickedAppointment) AppointmentDetailView.DataContext = clickedAppointment;
        AppointmentDetailView.Visibility = Visibility.Visible;   
        PictureStackpanel.Visibility = Visibility.Collapsed;    
    }
    ...
    private async Task showAddApointmentPopupAsync()
    {
        ...
        if (result == ContentDialogResult.Primary)
        {
                ...
                string.IsNullOrWhiteSpace(durationNumberBox.Text))
            {
                ...
                {
                    Title = "Waarschuwing",
                    Content = "Een of Meerdere Velden Zijn Onjuist/Niet Ingevuld!",
            ...
            try
            {
                ...
                {
                    Title = "Gelukt!",
                    Content = "De Afspraak is Opgeslagen!",
                    CloseButtonText = "OK",
                    DefaultButton = ContentDialogButton.Close,
                    XamlRoot = XamlRoot
                }.ShowAsync();
            ...
            catch (Exception ex)
            {
                ...
                {
                    Title = "Waarschuwing",
                    Content = $"Tijdens Het Opslaan Heeft Zich een Fout Voorgedaan: {ex.Message}",
                    CloseButtonText = "OK",
                    DefaultButton = ContentDialogButton.Close,
                    XamlRoot = XamlRoot
                }.ShowAsync();
